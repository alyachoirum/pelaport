...
class SlipGajiDetail extends StatefulWidget {
  ...
  final String nik;
  final String judul;
  const SlipGajiDetail({Key? key, required this.bulan,required this.nik,required this.judul}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:IndexedStack(
            ...
            WebView(
                  initialUrl: 'http://$baseUrl/webview/detail_slip_gaji/$_bulan?nik=$_nik',
